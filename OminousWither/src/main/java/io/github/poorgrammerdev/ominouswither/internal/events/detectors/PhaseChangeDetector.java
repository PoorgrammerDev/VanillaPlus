        ...
        public void run() {
                ...
                if (world != null) {
                    ...
                    for (int i = 0; i <= index ; i++) {
                        ParticleShapes.line(new ParticleInfo(Particle.SOUL_FIRE_FLAME, 3, 0.125, 0.125, 0.125), wither.getEyeLocation().subtract(0,1,0), wither.getLocation().add(this.anchorDirections[i]), 100.0);
                    }
